...
$execute as @s[scores={legit_gui.min_time_before_close=20..}] positioned 5000 1.65 $(player_id) positioned ~$(gui_id) ~ ~ unless entity @n[type=arrow,tag=shulker_detection,dx=0] positioned ~ ~-1 ~ run tag @s remove opened_gui.crafting_table
$execute as @s[scores={legit_gui.min_time_before_close=20..}] positioned 5000 1.65 $(player_id) positioned ~$(gui_id) ~ ~ unless entity @n[type=arrow,tag=shulker_detection,dx=0] positioned ~ ~-1 ~ run kill @n[type=arrow,tag=shulker_detection]
...
$execute positioned 5000 0 $(player_id) positioned ~$(gui_id) ~ ~ run function legit_guis:per_id_gui/gui_commands/$(gui_id) with storage legit_guis:packets gui_basic